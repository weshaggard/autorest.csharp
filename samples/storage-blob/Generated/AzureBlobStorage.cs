...
namespace DefaultNS.AzureBlobStorage
{
    ...
    public static partial class AzureBlobStorage
    {
        ...
        public static partial class ServiceOperations
        {
                ...
                String? xMSClientRequestID = default)
            {
                ...
                // Create the body
                System.Xml.Linq.XElement _body = Object.ToXml(blobServiceProperties, "StorageServiceProperties", "");
                ...
                Azure.Response response)
            {
                ...
                switch (response.Status)
                {
                    case 202:
                    {
                        ...
                        {
                            _value.LeaseTime = (LeaseTime)System.Enum.Parse(typeof(LeaseTime), _header, false);
                        }
            ...
            #region Container.Container_ListBlobsFlatSegment
            /// <summary>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>Success.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response<Object>> ContainerListBlobsFlatSegmentAsync(
                Object pipeline,
                String? url = default,
                string restype,
                string comp,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.ContainerClient.Container_ListBlobsFlatSegment",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = ContainerListBlobsFlatSegmentAsync_CreateRequest(
                        pipeline,
                        url,
                        restype,
                        comp,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return ContainerListBlobsFlatSegmentAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the Container.Container_ListBlobsFlatSegment request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The Container.Container_ListBlobsFlatSegment Request.</returns>
            internal static Azure.Core.Http.Request ContainerListBlobsFlatSegmentAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string restype,
                string comp,
            ...
            /// <summary>
            /// Create the Container.Container_ListBlobsFlatSegment response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The Container.Container_ListBlobsFlatSegment Azure.Response{Object}.</returns>
            internal static Azure.Response<Object> ContainerListBlobsFlatSegmentAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion Container.Container_ListBlobsFlatSegment

            #region Container.Container_ListBlobsHierarchySegment
            /// <summary>
            /// [Update] The List Blobs operation returns a list of the blobs under the specified container
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>Success.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response<Object>> ContainerListBlobsHierarchySegmentAsync(
                Object pipeline,
                String? url = default,
                string restype,
                string comp,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.ContainerClient.Container_ListBlobsHierarchySegment",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = ContainerListBlobsHierarchySegmentAsync_CreateRequest(
                        pipeline,
                        url,
                        restype,
                        comp,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return ContainerListBlobsHierarchySegmentAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the Container.Container_ListBlobsHierarchySegment request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The Container.Container_ListBlobsHierarchySegment Request.</returns>
            internal static Azure.Core.Http.Request ContainerListBlobsHierarchySegmentAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string restype,
                string comp,
            ...
            /// <summary>
            /// Create the Container.Container_ListBlobsHierarchySegment response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The Container.Container_ListBlobsHierarchySegment Azure.Response{Object}.</returns>
            internal static Azure.Response<Object> ContainerListBlobsHierarchySegmentAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion Container.Container_ListBlobsHierarchySegment
                ...
                Azure.Response response)
            {
                ...
                switch (response.Status)
                {
                    case 200:
                    {
                        ...
                        {
                            _value.IsIncrementalCopy = (IsIncrementalCopy)System.Enum.Parse(typeof(IsIncrementalCopy), _header, false);
                        }
                        ...
                        if (response.Headers.TryGetValue("Content-Encoding", out _header))
                        {
                            _value.ContentEncoding = (UNKNOWN ENUM TYPE NAME)System.Enum.Parse(typeof(UNKNOWN ENUM TYPE NAME), _header, false);
                        }
                        if (response.Headers.TryGetValue("Content-Disposition", out _header))
                        {
                            _value.ContentDisposition = _header;
                        ...
                        if (response.Headers.TryGetValue("Content-Language", out _header))
                        {
                            _value.ContentLanguage = (UNKNOWN ENUM TYPE NAME)System.Enum.Parse(typeof(UNKNOWN ENUM TYPE NAME), _header, false);
                        }
                        if (response.Headers.TryGetValue("Cache-Control", out _header))
                        {
                            _value.CacheControl = _header;
                        ...
                        {
                            _value.AccessTierInferred = (AccessTierInferred)System.Enum.Parse(typeof(AccessTierInferred), _header, false);
                        }
            ...
            public static async System.Threading.Tasks.Task<Azure.Response> PageBlobCreateAsync(
                ...
                Array? xMSBlobContentEncoding = default,
                Array? xMSBlobContentLanguage = default,
                ...
                String? xMSClientRequestID = default)
            {
                ...
                if (xMSBlobContentEncoding != null) { _request.Headers.SetValue("x-ms-blob-content-encoding", UNKNOWN ENUM TYPE NAME); }
                if (xMSBlobContentLanguage != null) { _request.Headers.SetValue("x-ms-blob-content-language", UNKNOWN ENUM TYPE NAME); }
            ...
            #region Blob.Blob_StartCopyFromUri
            /// <summary>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The operation completed successfully.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response> BlobStartCopyFromUriAsync(
                Object pipeline,
                String? url = default,
                Integer? timeout = default,
                String? xMSMeta = default,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.BlobClient.Blob_StartCopyFromUri",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = BlobStartCopyFromUriAsync_CreateRequest(
                        pipeline,
                        url,
                        timeout,
                        xMSMeta,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return BlobStartCopyFromUriAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the Blob.Blob_StartCopyFromUri request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The Blob.Blob_StartCopyFromUri Request.</returns>
            internal static Azure.Core.Http.Request BlobStartCopyFromUriAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                Integer? timeout = default,
                String? xMSMeta = default,
            ...
            /// <summary>
            /// Create the Blob.Blob_StartCopyFromUri response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The Blob.Blob_StartCopyFromUri Azure.Response.</returns>
            internal static Azure.Response BlobStartCopyFromUriAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion Blob.Blob_StartCopyFromUri

            #region Blob.Blob_CopyFromUri
            /// <summary>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The operation completed successfully.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response> BlobCopyFromUriAsync(
                Object pipeline,
                String? url = default,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.BlobClient.Blob_CopyFromUri",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = BlobCopyFromUriAsync_CreateRequest(
                        pipeline,
                        url,
                        xMSRequiresSync,
                        timeout,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return BlobCopyFromUriAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the Blob.Blob_CopyFromUri request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The Blob.Blob_CopyFromUri Request.</returns>
            internal static Azure.Core.Http.Request BlobCopyFromUriAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string xMSRequiresSync,
                Integer? timeout = default,
            ...
            /// <summary>
            /// Create the Blob.Blob_CopyFromUri response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The Blob.Blob_CopyFromUri Azure.Response.</returns>
            internal static Azure.Response BlobCopyFromUriAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion Blob.Blob_CopyFromUri
            ...
            #region Blob.Blob_AbortCopyFromUri
            /// <summary>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The delete request was accepted and the blob will be deleted.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response> BlobAbortCopyFromUriAsync(
                Object pipeline,
                String? url = default,
                string comp,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.BlobClient.Blob_AbortCopyFromUri",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = BlobAbortCopyFromUriAsync_CreateRequest(
                        pipeline,
                        url,
                        comp,
                        xMSCopyAction,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return BlobAbortCopyFromUriAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the Blob.Blob_AbortCopyFromUri request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The Blob.Blob_AbortCopyFromUri Request.</returns>
            internal static Azure.Core.Http.Request BlobAbortCopyFromUriAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string comp,
                string xMSCopyAction,
            ...
            /// <summary>
            /// Create the Blob.Blob_AbortCopyFromUri response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The Blob.Blob_AbortCopyFromUri Azure.Response.</returns>
            internal static Azure.Response BlobAbortCopyFromUriAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion Blob.Blob_AbortCopyFromUri
            ...
            #region BlockBlob.BlockBlob_StageBlockFromUri
            /// <summary>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The operation completed successfully.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response> BlockBlobStageBlockFromUriAsync(
                Object pipeline,
                String? url = default,
                string comp,
                String blockid,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.BlockBlobClient.BlockBlob_StageBlockFromUri",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = BlockBlobStageBlockFromUriAsync_CreateRequest(
                        pipeline,
                        url,
                        comp,
                        blockid,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return BlockBlobStageBlockFromUriAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the BlockBlob.BlockBlob_StageBlockFromUri request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The BlockBlob.BlockBlob_StageBlockFromUri Request.</returns>
            internal static Azure.Core.Http.Request BlockBlobStageBlockFromUriAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string comp,
                String blockid,
            ...
            /// <summary>
            /// Create the BlockBlob.BlockBlob_StageBlockFromUri response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The BlockBlob.BlockBlob_StageBlockFromUri Azure.Response.</returns>
            internal static Azure.Response BlockBlobStageBlockFromUriAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion BlockBlob.BlockBlob_StageBlockFromUri
  ...
  - Clear: Clears the specified range and releases the space used in storage for that range. To clear a range, set the Content-Length header to zero, and the Range header to a value that indicates the range to clear, up to maximum blob size.</param>
            ...
            #region PageBlob.PageBlob_UploadPagesFromUri
            /// <summary>
  ...
  - Clear: Clears the specified range and releases the space used in storage for that range. To clear a range, set the Content-Length header to zero, and the Range header to a value that indicates the range to clear, up to maximum blob size.</param>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The operation completed successfully.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response> PageBlobUploadPagesFromUriAsync(
                Object pipeline,
                String? url = default,
                string comp,
                string xMSPageWrite,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.PageBlobClient.PageBlob_UploadPagesFromUri",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = PageBlobUploadPagesFromUriAsync_CreateRequest(
                        pipeline,
                        url,
                        comp,
                        xMSPageWrite,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return PageBlobUploadPagesFromUriAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the PageBlob.PageBlob_UploadPagesFromUri request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
  ...
  - Clear: Clears the specified range and releases the space used in storage for that range. To clear a range, set the Content-Length header to zero, and the Range header to a value that indicates the range to clear, up to maximum blob size.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The PageBlob.PageBlob_UploadPagesFromUri Request.</returns>
            internal static Azure.Core.Http.Request PageBlobUploadPagesFromUriAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string comp,
                string xMSPageWrite,
            ...
            /// <summary>
            /// Create the PageBlob.PageBlob_UploadPagesFromUri response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The PageBlob.PageBlob_UploadPagesFromUri Azure.Response.</returns>
            internal static Azure.Response PageBlobUploadPagesFromUriAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion PageBlob.PageBlob_UploadPagesFromUri
            ...
            #region AppendBlob.AppendBlob_AppendBlockFromUri
            /// <summary>
            ...
            /// <param name="cancellationToken">Cancellation token.</param>
            /// <returns>The operation completed successfully.</returns>
            public static async System.Threading.Tasks.Task<Azure.Response> AppendBlobAppendBlockFromUriAsync(
                Object pipeline,
                String? url = default,
                string comp,
                String xMSCopySource,
                ...
                string xMSVersion,
                String? xMSClientRequestID = default,
                string operationName = "DefaultNS.AzureBlobStorage.AppendBlobClient.AppendBlob_AppendBlockFromUri",
                System.Threading.CancellationToken cancellationToken = default)
            {
                Azure.Core.Pipeline.DiagnosticScope _scope = pipeline.Diagnostics.CreateScope(operationName);
                try
                {
                    _scope.Start();
                    using (Azure.Core.Http.Request _request = AppendBlobAppendBlockFromUriAsync_CreateRequest(
                        pipeline,
                        url,
                        comp,
                        xMSCopySource,
                        ...
                        xMSClientRequestID))
                    {
                        Azure.Response _response = await pipeline.SendRequestAsync(_request, cancellationToken).ConfigureAwait(false);
                        cancellationToken.ThrowIfCancellationRequested();
                        return AppendBlobAppendBlockFromUriAsync_CreateResponse(_response);
                    }
                }
                catch (System.Exception ex)
                {
            ...
            /// <summary>
            /// Create the AppendBlob.AppendBlob_AppendBlockFromUri request.
            /// </summary>
            /// <param name="pipeline">The pipeline used for sending requests.</param>
            /// <param name="pipeline">pipeline</param>
            /// <param name="url">The URL of the service account, container, or blob that is the targe of the desired operation.</param>
            ...
            /// <param name="xMSVersion">Specifies the version of the operation to use for this request.</param>
            /// <param name="xMSClientRequestID">Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled.</param>
            /// <returns>The AppendBlob.AppendBlob_AppendBlockFromUri Request.</returns>
            internal static Azure.Core.Http.Request AppendBlobAppendBlockFromUriAsync_CreateRequest(
                Object pipeline,
                String? url = default,
                string comp,
                String xMSCopySource,
            ...
            /// <summary>
            /// Create the AppendBlob.AppendBlob_AppendBlockFromUri response or throw a failure exception.
            /// </summary>
            /// <param name="response">The raw Response.</param>
            /// <returns>The AppendBlob.AppendBlob_AppendBlockFromUri Azure.Response.</returns>
            internal static Azure.Response AppendBlobAppendBlockFromUriAsync_CreateResponse(
                Azure.Response response)
            {
                // Process the response
                switch (response.Status)
            ...
            #endregion AppendBlob.AppendBlob_AppendBlockFromUri
                ...
                Azure.Response response)
            {
                ...
                switch (response.Status)
                {
                    case 200:
                    {
                        ...
                        {
                            _value.HasImmutabilityPolicy = (HasImmutabilityPolicy)System.Enum.Parse(typeof(HasImmutabilityPolicy), _header, false);
                        }
                        if (response.Headers.TryGetValue("HasLegalHold", out _header))
                        {
                            _value.HasLegalHold = (HasLegalHold)System.Enum.Parse(typeof(HasLegalHold), _header, false);
                        }
